...
export 'vendedor_menu_facturas_model.dart';

class VendedorMenuFacturasWidget extends StatefulWidget {
  const VendedorMenuFacturasWidget({super.key});

  @override
  State<VendedorMenuFacturasWidget> createState() =>
      _VendedorMenuFacturasWidgetState();
}

class _VendedorMenuFacturasWidgetState
    extends State<VendedorMenuFacturasWidget> {
  late VendedorMenuFacturasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VendedorMenuFacturasModel());
  }
