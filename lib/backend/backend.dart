...
import 'schema/empresa_cliente_record.dart';
import 'schema/rutas_record.dart';
import 'schema/productos_record.dart';
import 'schema/factura_record.dart';
import 'schema/ordenes_record.dart';
import 'schema/camion_record.dart';
...
export 'schema/empresa_cliente_record.dart';
export 'schema/rutas_record.dart';
export 'schema/productos_record.dart';
export 'schema/factura_record.dart';
export 'schema/ordenes_record.dart';
export 'schema/camion_record.dart';
...
/// Functions to query EmpresaClienteRecords (as a Stream and as a Future).
Future<int> queryEmpresaClienteRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      EmpresaClienteRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<EmpresaClienteRecord>> queryEmpresaClienteRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      EmpresaClienteRecord.collection,
      EmpresaClienteRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<EmpresaClienteRecord>> queryEmpresaClienteRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query RutasRecords (as a Stream and as a Future).
Future<int> queryRutasRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      RutasRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<RutasRecord>> queryRutasRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      RutasRecord.collection,
      RutasRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<RutasRecord>> queryRutasRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query CamionRecords (as a Stream and as a Future).
Future<int> queryCamionRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      CamionRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<CamionRecord>> queryCamionRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      CamionRecord.collection,
      CamionRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<CamionRecord>> queryCamionRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
