...
import 'admin_menu_ruta_model.dart';
export 'admin_menu_ruta_model.dart';

class AdminMenuRutaWidget extends StatefulWidget {
  const AdminMenuRutaWidget({super.key});

  @override
  State<AdminMenuRutaWidget> createState() => _AdminMenuRutaWidgetState();
}

class _AdminMenuRutaWidgetState extends State<AdminMenuRutaWidget> {
  late AdminMenuRutaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminMenuRutaModel());
  }
