...
import 'admin_menu_vendedor_model.dart';
export 'admin_menu_vendedor_model.dart';

class AdminMenuVendedorWidget extends StatefulWidget {
  const AdminMenuVendedorWidget({super.key});

  @override
  State<AdminMenuVendedorWidget> createState() =>
      _AdminMenuVendedorWidgetState();
}

class _AdminMenuVendedorWidgetState extends State<AdminMenuVendedorWidget> {
  late AdminMenuVendedorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminMenuVendedorModel());
  }
