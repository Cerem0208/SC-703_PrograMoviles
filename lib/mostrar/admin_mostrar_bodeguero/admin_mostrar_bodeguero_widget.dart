...
import 'admin_mostrar_bodeguero_model.dart';
export 'admin_mostrar_bodeguero_model.dart';

class AdminMostrarBodegueroWidget extends StatefulWidget {
  const AdminMostrarBodegueroWidget({super.key});

  @override
  State<AdminMostrarBodegueroWidget> createState() =>
      _AdminMostrarBodegueroWidgetState();
}

class _AdminMostrarBodegueroWidgetState
    extends State<AdminMostrarBodegueroWidget> {
  late AdminMostrarBodegueroModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminMostrarBodegueroModel());
  }
