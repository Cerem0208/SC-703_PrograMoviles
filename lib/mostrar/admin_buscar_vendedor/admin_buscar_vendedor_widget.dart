...
export 'admin_buscar_vendedor_model.dart';

class AdminBuscarVendedorWidget extends StatefulWidget {
  const AdminBuscarVendedorWidget({super.key});

  @override
  State<AdminBuscarVendedorWidget> createState() =>
      _AdminBuscarVendedorWidgetState();
}

class _AdminBuscarVendedorWidgetState extends State<AdminBuscarVendedorWidget> {
  late AdminBuscarVendedorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminBuscarVendedorModel());
  }
